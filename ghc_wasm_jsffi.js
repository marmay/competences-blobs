...
ZC0ZCcompetenceszmfrontendzm1zi5zi1zi0zminplaceZCCompetencesziFrontendziComponentziWindowHostZC: () => (window.onbeforeunload = null),
ZC1ZCcompetenceszmfrontendzm1zi5zi1zi0zminplaceZCCompetencesziFrontendziComponentziWindowHostZC: () => (window.onbeforeunload = function(e){return ''}),
ZC0ZCcompetenceszmfrontendzm1zi5zi1zi0zminplaceZCCompetencesziFrontendziSvgEmbedziManagerZC: async ($1,$2) => (await MathJax.tex2svgPromise($1, {display: $2})),
ZC0ZCcompetenceszmfrontendzm1zi5zi1zi0zminplaceZCCompetencesziFrontendziBinaryFFIZC: async ($1) => (new Uint8Array(await $1.arrayBuffer())),
ZC1ZCcompetenceszmfrontendzm1zi5zi1zi0zminplaceZCCompetencesziFrontendziBinaryFFIZC: ($1) => ($1 == null),
ZC2ZCcompetenceszmfrontendzm1zi5zi1zi0zminplaceZCCompetencesziFrontendziBinaryFFIZC: ($1) => ($1.size),
ZC3ZCcompetenceszmfrontendzm1zi5zi1zi0zminplaceZCCompetencesziFrontendziBinaryFFIZC: ($1) => ($1.type),
ZC4ZCcompetenceszmfrontendzm1zi5zi1zi0zminplaceZCCompetencesziFrontendziBinaryFFIZC: ($1) => ($1.name),
ZC5ZCcompetenceszmfrontendzm1zi5zi1zi0zminplaceZCCompetencesziFrontendziBinaryFFIZC: ($1) => ($1.files[0]),
ZC6ZCcompetenceszmfrontendzm1zi5zi1zi0zminplaceZCCompetencesziFrontendziBinaryFFIZC: ($1,$2,$3) => ((() => { const blob = new Blob([$1], { type: $2 }); const url = URL.createObjectURL(blob); const a = document.createElement('a'); a.href = url; a.download = $3; document.body.appendChild(a); a.click(); document.body.removeChild(a); URL.revokeObjectURL(url); })()),
ZC7ZCcompetenceszmfrontendzm1zi5zi1zi0zminplaceZCCompetencesziFrontendziBinaryFFIZC: ($1,$2) => (new Uint8Array(new Uint8Array(__exports.memory.buffer, $1, $2))),
ZC8ZCcompetenceszmfrontendzm1zi5zi1zi0zminplaceZCCompetencesziFrontendziBinaryFFIZC: ($1,$2) => ((new Uint8Array(__exports.memory.buffer, $2, $1.byteLength)).set($1)),
ZC9ZCcompetenceszmfrontendzm1zi5zi1zi0zminplaceZCCompetencesziFrontendziBinaryFFIZC: ($1) => ($1.byteLength),
ZC10ZCcompetenceszmfrontendzm1zi5zi1zi0zminplaceZCCompetencesziFrontendziBinaryFFIZC: ($1) => (new Uint8Array($1)),
ZC0ZCcompetenceszmfrontendzm1zi5zi1zi0zminplaceZCCompetencesziFrontendziIndexedDBZC: ($1) => ($1 == null),
ZC1ZCcompetenceszmfrontendzm1zi5zi1zi0zminplaceZCCompetencesziFrontendziIndexedDBZC: async ($1,$2) => (await new Promise((resolve, reject) => { const tx = $1.transaction(['checkpoints'], 'readwrite'); const store = tx.objectStore('checkpoints'); store.delete($2); tx.oncomplete = () => resolve(); tx.onerror = (e) => reject(e.target.error); })),
ZC2ZCcompetenceszmfrontendzm1zi5zi1zi0zminplaceZCCompetencesziFrontendziIndexedDBZC: async ($1,$2) => (await new Promise((resolve, reject) => { const tx = $1.transaction(['checkpoints'], 'readonly'); const store = tx.objectStore('checkpoints'); const req = store.get($2); req.onsuccess = () => resolve(req.result); req.onerror = (e) => reject(e.target.error); })),
ZC3ZCcompetenceszmfrontendzm1zi5zi1zi0zminplaceZCCompetencesziFrontendziIndexedDBZC: async ($1,$2,$3) => (await new Promise((resolve, reject) => { const tx = $1.transaction(['checkpoints'], 'readwrite'); const store = tx.objectStore('checkpoints'); store.put($3, $2); tx.oncomplete = () => resolve(); tx.onerror = (e) => reject(e.target.error); })),
ZC4ZCcompetenceszmfrontendzm1zi5zi1zi0zminplaceZCCompetencesziFrontendziIndexedDBZC: async () => (await new Promise((resolve, reject) => { const req = indexedDB.open('competences-checkpoints', 1); req.onupgradeneeded = (e) => { const db = e.target.result; if (!db.objectStoreNames.contains('checkpoints')) { db.createObjectStore('checkpoints'); } }; req.onsuccess = (e) => resolve(e.target.result); req.onerror = (e) => reject(e.target.error); })),
ZC5ZCcompetenceszmfrontendzm1zi5zi1zi0zminplaceZCCompetencesziFrontendziIndexedDBZC: async ($1) => (await crypto.subtle.digest('SHA-256', $1).then(buf => Array.from(new Uint8Array(buf)).map(b => b.toString(16).padStart(2, '0')).join(''))),
...
ZC0ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCMisoziJSONZC: ($1) => {return globalThis.miso.typeOf($1);},
ZC2ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCMisoziJSONZC: ($1) => {return JSON.stringify($1);},
ZC2ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCMisoziDSLziFFIZC: ($1) => {return $1.length},
ZC3ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCMisoziDSLziFFIZC: ($1) => {return Array.isArray($1);},
ZC5ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCMisoziDSLziFFIZC: ($1) => {return requestAnimationFrame($1);},
ZC6ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCMisoziDSLziFFIZC: ($1,$2) => {return $2[$1]},
ZC7ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCMisoziDSLziFFIZC: ($1) => {return $1},
ZC8ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCMisoziDSLziFFIZC: ($1) => {return $1},
ZC9ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCMisoziDSLziFFIZC: ($1) => {return $1},
ZC11ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCMisoziDSLziFFIZC: ($1,$2) => {return $2[$1]},
ZC12ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCMisoziDSLziFFIZC: () => {return {}},
ZC13ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCMisoziDSLziFFIZC: ($1,$2) => {return new $1(...$2)},
ZC14ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCMisoziDSLziFFIZC: ($1,$2,$3) => ($3[$1]=$2),
ZC16ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCMisoziDSLziFFIZC: ($1,$2,$3) => {return $1.apply($2, $3);},
ZC17ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCMisoziDSLziFFIZC: ($1) => {return Object.keys($1);},
ZC23ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCMisoziDSLziFFIZC: ($1) => ((...args) => __exports.ghczuwasmzujsffiZC22ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCMisoziDSLziFFIZC($1, ...args)),
ZC31ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCMisoziDSLziFFIZC: ($1) => ((...args) => __exports.ghczuwasmzujsffiZC30ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCMisoziDSLziFFIZC($1, ...args)),
ZC37ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCMisoziDSLziFFIZC: ($1) => ((...args) => __exports.ghczuwasmzujsffiZC36ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCMisoziDSLziFFIZC($1, ...args)),
ZC39ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCMisoziDSLziFFIZC: ($1) => ((...args) => __exports.ghczuwasmzujsffiZC38ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCMisoziDSLziFFIZC($1, ...args)),
ZC42ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCMisoziDSLziFFIZC: () => {return globalThis},
ZC43ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCMisoziDSLziFFIZC: () => {return null;},
ZC44ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCMisoziDSLziFFIZC: ($1) => {return $1 === null;},
ZC45ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCMisoziDSLziFFIZC: ($1) => {return $1 === undefined;},
ZC46ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCMisoziDSLziFFIZC: ($1) => {return $1},
ZC51ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCMisoziDSLziFFIZC: ($1,$2) => ($1.push($2)),
ZC52ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCMisoziDSLziFFIZC: () => {return [];},
ZC53ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCMisoziDSLziFFIZC: ($1) => {return $1},
ZC54ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCMisoziDSLziFFIZC: ($1) => {return $1},
ZC55ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCMisoziDSLziFFIZC: ($1) => {if ($1 === 0.0) return false;
return true;},
ZC3ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCDataziJSStringZC: ($1) => {return ($1).toString()},
ZC4ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCDataziJSStringZC: () => {return ''},
ZC5ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCDataziJSStringZC: ($1,$2) => {return $1 + $2},
ZC6ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCDataziJSStringZC: ($1,$2) => {return $1 === $2},
ZC7ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCDataziJSStringZC: ($1,$2) => {if ($1 < 1) { return ''; }
...
ZC8ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCDataziJSStringZC: ($1,$2) => {if ($1 === $2) return 0;
else if ($1 > $2) return 1;
else return -1;},
ZC9ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCDataziJSStringZC: ($1) => {return $1.slice(1,$1.length)},
ZC10ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCDataziJSStringZC: ($1) => {if ($1.length === 0) throw new Error ('head: empty string');
return $1.slice(0).charCodeAt();},
ZC11ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCDataziJSStringZC: ($1) => {return String.fromCharCode($1);},
ZC12ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCDataziJSStringZC: ($1,$2) => {return $2.startsWith($1)},
ZC13ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCDataziJSStringZC: ($1) => {return $1.length},
ZC14ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCDataziJSStringZC: ($1,$2) => {if ($1 < 1 || $2.length === 0) return $2;
return $2.slice($1, $2.length);},
ZC15ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCDataziJSStringZC: ($1) => {return $1.length === 0},
ZC16ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCDataziJSStringZC: ($1,$2) => ((new TextDecoder('utf-8', {fatal: true})).decode(new Uint8Array(__exports.memory.buffer, $1, $2))),
ZC17ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCDataziJSStringZC: ($1,$2) => ((new Uint8Array(__exports.memory.buffer, $2, $1.byteLength)).set($1)),
ZC18ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCDataziJSStringZC: ($1) => ($1.byteLength),
ZC19ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCDataziJSStringZC: ($1) => ((new TextEncoder()).encode($1)),
ZC42ZCmisozm1zi9zi0zi0zm0213cbbc051a564dd3fbe6c19d98ae4ccd6673d47a28d39ad7c73a710d6bd514ZCDataziJSStringZC: ($1,$2) => {return $1 + String.fromCharCode($2);},
